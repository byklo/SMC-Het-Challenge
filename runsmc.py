...
SCRIPT_PATH = './SMC-Het-Challenge/smc_het_eval/SMCScoring.py' if not args.og else './SMC-Het-CHallenge/smc_het_eval/SMCScoring.original.py'
DATA_ROOT_DIR = './data/kbuckets'
OUTPUT_DIR = './SMC-Het-Challenge/output-%s' % args.challenge[0]
